...
(function(){var b;b=function(){function a(a,c){this.frame_url=a;this.key=c;if(null==this.frame_url)throw Error("ChatleClient.Transport constructor call without frame_url");if(null==this.key)throw Error("ChatleClient.Transport constructor call without key");this.iframe=document.createElement("iframe");this.iframe.src=this.frame_url;this.iframe.setAttribute("style","width:0;height:0;display:none");document.body.appendChild(this.iframe);this.queue=[];this.data=null;window.addEventListener("message",
function(a){var f;if(null!=this.data)return a=a.data,"function"===typeof(f=this.data).callback?f.callback("ok"===a.status?null:a.errorStatus,"ok"===a.status?a.data:null):void 0})}a.prototype.interval=function(){var a,c;if(null!=this.data){a=this.iframe.src.split("#")[1];if(null==a||a===this.data.hash||""===a)return;a=JSON.parse(a);"function"===typeof(c=this.data).callback&&c.callback("ok"===a.status?null:a.errorStatus,"ok"===a.status?a.data:null);this.data=null}return this.sendCommandToFrame()};a.prototype.sendCommandToFrame=
function(){if(null==this.data&&0!==this.queue.length)return this.data=this.queue.shift(),this.iframe.contentWindow.postMessage(this.data.command,"*")};a.prototype.sendCommand=function(a,c,d,b){this.queue.push({command:{id:1,type:a,url:c,data:d,headers:{"X-AppKey":this.key}},callback:b});return this.sendCommandToFrame()};a.prototype.get=function(a,c,b){return this.sendCommand("GET",a,c,b)};a.prototype.post=function(a,c,b){return this.sendCommand("POST",a,c,b)};a.prototype.put=function(a,c,b){return this.sendCommand("PUT",
