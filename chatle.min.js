...
function(a){var d;if(null!=b.data)return d=a.data,a=b.data,b.data=null,"function"===typeof a.callback?a.callback("ok"===d.status?null:d.errorStatus,"ok"===d.status?d.data:null):void 0})}b.prototype.interval=function(){var a,d;if(null!=this.data){a=this.iframe.src.split("#")[1];if(null==a||a===this.data.hash||""===a)return;d=JSON.parse(a);a=this.data;this.data=null;"function"===typeof a.callback&&a.callback("ok"===d.status?null:d.errorStatus,"ok"===d.status?d.data:null)}return this.sendCommandToFrame()};
b.prototype.sendCommandToFrame=function(){if(null==this.data&&0!==this.queue.length)return this.data=this.queue.shift(),null!=this.authToken&&(null==this.data.command.headers&&(this.data.command.headers={}),this.data.command.headers["X-Auth-Token"]=this.authToken),this.iframe.contentWindow.postMessage(this.data.command,"*")};b.prototype.sendCommand=function(a,d,b,c){this.queue.push({command:{id:1,type:a,url:d,data:b,headers:{"X-AppKey":this.key}},callback:c});return this.sendCommandToFrame()};b.prototype.get=
function(a,d,b){return this.sendCommand("GET",a,d,b)};b.prototype.post=function(a,d,b){return this.sendCommand("POST",a,d,b)};b.prototype.put=function(a,d,b){return this.sendCommand("PUT",a,d,b)};b.prototype["delete"]=function(a,d,b){return this.sendCommand("DELETE",a,d,b)};return b}();ChatleClient.Transport=c}).call(this);
