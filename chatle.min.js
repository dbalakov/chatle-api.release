...
function(a){var d;if(null!=b.data)return a=a.data,"function"===typeof(d=b.data).callback&&d.callback("ok"===a.status?null:a.errorStatus,"ok"===a.status?a.data:null),b.data=null})}b.prototype.interval=function(){var a,d;if(null!=this.data){a=this.iframe.src.split("#")[1];if(null==a||a===this.data.hash||""===a)return;a=JSON.parse(a);"function"===typeof(d=this.data).callback&&d.callback("ok"===a.status?null:a.errorStatus,"ok"===a.status?a.data:null);this.data=null}return this.sendCommandToFrame()};b.prototype.sendCommandToFrame=
