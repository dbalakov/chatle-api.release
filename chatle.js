  ...
  Transport = (function() {
    function Transport(frame_url, key) {
      ...
      window.addEventListener('message', function(event) {
        ...
        result = event.data;
        return typeof (_base = this.data).callback === "function" ? _base.callback((result.status === 'ok' ? null : result.errorStatus), (result.status === 'ok' ? result.data : null)) : void 0;
      });
    }
