...
(function() {
  ...
  Transport = (function() {
    function Transport(frame_url, key) {
      ...
      this.key = key;
      this.sendCommandToFrame = __bind(this.sendCommandToFrame, this);
      ...
      this.iframe.src = "" + this.frame_url + "#window.location";
      ...
      window.addEventListener('message', function(event) {
        ...
        if (typeof data.callback === "function") {
          data.callback((result.status === 'ok' ? null : result.errorStatus), (result.status === 'ok' ? result.data : null));
        }
        return _this.sendCommandToFrame();
      });
      setInterval(this.sendCommandToFrame, 100);
    }
    ...
    Transport.prototype.sendCommandToFrame = function() {
      ...
      if (this.authToken != null) {
        if (this.data.command.headers == null) {
          this.data.command.headers = {};
        }
        this.data.command.headers['X-Auth-Token'] = this.authToken;
      }
      return this.iframe.contentWindow.postMessage(this.data.command, '*');
    };
...
// Generated by CoffeeScript 1.6.3
(function() {
  var GUID_CHARS, Rooms, generateGuid;
